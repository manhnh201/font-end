...
export class PeriOrderService extends BaseDomainService {
  override prefixApiPath = '/api/v2';
  domainName: string = 'orders/details';

  // Tạo Subject để truyền data giữa các component
  public periOrderFilter = new BehaviorSubject<TableFilter>(new TableFilter());
  periOrderFilter$ = this.periOrderFilter.asObservable();
