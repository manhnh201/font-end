...
export const environment = {
  ...
  apiUrl: 'http://10.100.30.104:81/kbs-oss-be',
  // apiUrl: 'http://10.100.120.58/cms/manager',
  // apiUrl: 'http://10.100.30.100:8089/peri-order',
  // apiUrl: 'http://10.100.20.99/authentication-be-v1.0.1',

  feedbackApiUrl: 'http://10.100.30.100:3030',
  ...
  IDLE_TIME_TO_AUTO_LOGOUT: 14400,
  ...
  modules: [
    ...
    new MenuItem('Authentication', [], '', `http://10.100.20.99/authentication`),
    new MenuItem('Email Automation', [], '', `http://10.100.20.99`),
    new MenuItem('Messaging Platform', [], '', `http://10.100.20.99/messaging-platform`),
    new MenuItem('KBS CMS', [], '', `https://10.100.30.104`),
    new MenuItem('CMS Portal', [], '', `http://10.100.30.104:8086/wp-admin`),
